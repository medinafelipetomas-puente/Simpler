...
export function IconUrl({ className = "", size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconCommand({ className = "", size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconCoffee({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconGamepad({ className = "", size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconSearchFolder({ className = "", size = 16 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconRefreshCw({ className = "", size = 16 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconWindows({ className = "", size = 18 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
